...
;// CONCATENATED MODULE: ../../node_modules/.pnpm/next@14.1.0_react-dom@18.3.1_react@18.3.1__react@18.3.1/node_modules/next/dist/esm/client/components/async-local-storage.js
...
// EXTERNAL MODULE: ../../node_modules/.pnpm/@supabase+auth-helpers-nextjs@0.9.0_@supabase+supabase-js@2.49.4/node_modules/@supabase/auth-helpers-nextjs/dist/index.js
...
var import_auth_helpers_shared = __webpack_require__(686);
var supabase;
function createClientComponentClient({ supabaseUrl = "https://xxgrccxrwcgjixzbjair.supabase.co", supabaseKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Inh4Z3JjY3hyd2Nnaml4emJqYWlyIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDQ5ODc5NDAsImV4cCI6MjA2MDU2Mzk0MH0.7fAJ7ghNvw3Io3gBXyGSwQw9qfrdlhGVx1_VK4zEqHQ", options, cookieOptions, isSingleton = true } = {}) {
...
var import_auth_helpers_shared2 = __webpack_require__(686);
var import_set_cookie_parser = __webpack_require__(653);
...
function createPagesServerClient(context, { supabaseUrl = "https://xxgrccxrwcgjixzbjair.supabase.co", supabaseKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Inh4Z3JjY3hyd2Nnaml4emJqYWlyIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDQ5ODc5NDAsImV4cCI6MjA2MDU2Mzk0MH0.7fAJ7ghNvw3Io3gBXyGSwQw9qfrdlhGVx1_VK4zEqHQ", options, cookieOptions } = {}) {
    var _a;
    if (!supabaseUrl || !supabaseKey) {
        throw new Error("either NEXT_PUBLIC_SUPABASE_URL and NEXT_PUBLIC_SUPABASE_ANON_KEY env variables or supabaseUrl and supabaseKey are required!");
    }
...
var import_auth_helpers_shared3 = __webpack_require__(686);
var import_set_cookie_parser2 = __webpack_require__(653);
...
function createMiddlewareClient(context, { supabaseUrl = "https://xxgrccxrwcgjixzbjair.supabase.co", supabaseKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Inh4Z3JjY3hyd2Nnaml4emJqYWlyIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDQ5ODc5NDAsImV4cCI6MjA2MDU2Mzk0MH0.7fAJ7ghNvw3Io3gBXyGSwQw9qfrdlhGVx1_VK4zEqHQ", options, cookieOptions } = {}) {
    var _a;
    if (!supabaseUrl || !supabaseKey) {
        throw new Error("either NEXT_PUBLIC_SUPABASE_URL and NEXT_PUBLIC_SUPABASE_ANON_KEY env variables or supabaseUrl and supabaseKey are required!");
    }
...
var import_auth_helpers_shared4 = __webpack_require__(686);
...
function createServerComponentClient(context, { supabaseUrl = "https://xxgrccxrwcgjixzbjair.supabase.co", supabaseKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Inh4Z3JjY3hyd2Nnaml4emJqYWlyIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDQ5ODc5NDAsImV4cCI6MjA2MDU2Mzk0MH0.7fAJ7ghNvw3Io3gBXyGSwQw9qfrdlhGVx1_VK4zEqHQ", options, cookieOptions } = {}) {
    var _a;
    if (!supabaseUrl || !supabaseKey) {
        throw new Error("either NEXT_PUBLIC_SUPABASE_URL and NEXT_PUBLIC_SUPABASE_ANON_KEY env variables or supabaseUrl and supabaseKey are required!");
    }
...
var import_auth_helpers_shared5 = __webpack_require__(686);
...
function createRouteHandlerClient(context, { supabaseUrl = "https://xxgrccxrwcgjixzbjair.supabase.co", supabaseKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Inh4Z3JjY3hyd2Nnaml4emJqYWlyIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDQ5ODc5NDAsImV4cCI6MjA2MDU2Mzk0MH0.7fAJ7ghNvw3Io3gBXyGSwQw9qfrdlhGVx1_VK4zEqHQ", options, cookieOptions } = {}) {
    var _a;
    if (!supabaseUrl || !supabaseKey) {
        throw new Error("either NEXT_PUBLIC_SUPABASE_URL and NEXT_PUBLIC_SUPABASE_ANON_KEY env variables or supabaseUrl and supabaseKey are required!");
    }
...
// src/deprecated.ts
function createBrowserSupabaseClient({ supabaseUrl = "https://xxgrccxrwcgjixzbjair.supabase.co", supabaseKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Inh4Z3JjY3hyd2Nnaml4emJqYWlyIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDQ5ODc5NDAsImV4cCI6MjA2MDU2Mzk0MH0.7fAJ7ghNvw3Io3gBXyGSwQw9qfrdlhGVx1_VK4zEqHQ", options, cookieOptions } = {}) {
...
function createServerSupabaseClient(context, { supabaseUrl = "https://xxgrccxrwcgjixzbjair.supabase.co", supabaseKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Inh4Z3JjY3hyd2Nnaml4emJqYWlyIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDQ5ODc5NDAsImV4cCI6MjA2MDU2Mzk0MH0.7fAJ7ghNvw3Io3gBXyGSwQw9qfrdlhGVx1_VK4zEqHQ", options, cookieOptions } = {}) {
...
function createMiddlewareSupabaseClient(context, { supabaseUrl = "https://xxgrccxrwcgjixzbjair.supabase.co", supabaseKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Inh4Z3JjY3hyd2Nnaml4emJqYWlyIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDQ5ODc5NDAsImV4cCI6MjA2MDU2Mzk0MH0.7fAJ7ghNvw3Io3gBXyGSwQw9qfrdlhGVx1_VK4zEqHQ", options, cookieOptions } = {}) {
...
// @ts-ignore
const node_fetch_1 = __importDefault(__webpack_require__(22));
const PostgrestError_1 = __importDefault(__webpack_require__(219));
...
const PostgrestQueryBuilder_1 = __importDefault(__webpack_require__(728));
const PostgrestFilterBuilder_1 = __importDefault(__webpack_require__(847));
const constants_1 = __webpack_require__(674);
/**
 * PostgREST client.
 *
...
const PostgrestTransformBuilder_1 = __importDefault(__webpack_require__(547));
...
const PostgrestBuilder_1 = __importDefault(__webpack_require__(96));
...
const version_1 = __webpack_require__(175);
...
const PostgrestClient_1 = __importDefault(__webpack_require__(954));
...
const resolveFetch = (customFetch)=>{
    ...
    if (customFetch) {
        ...
        _fetch = (...args)=>Promise.resolve(/* import() */).then(__webpack_require__.bind(__webpack_require__, 22)).then(({ default: fetch1 })=>fetch1(...args));
    } else {
        _fetch = fetch;
    }
...
// EXTERNAL MODULE: ../../node_modules/.pnpm/@supabase+postgrest-js@1.19.4/node_modules/@supabase/postgrest-js/dist/cjs/index.js
var cjs = __webpack_require__(112);
;// CONCATENATED MODULE: ../../node_modules/.pnpm/@supabase+postgrest-js@1.19.4/node_modules/@supabase/postgrest-js/dist/esm/wrapper.mjs
...
class RealtimeClient {
     ...
     */ connect() {
        ...
        Promise.resolve(/* import() */).then(__webpack_require__.t.bind(__webpack_require__, 44, 23)).then(({ default: WS })=>{
...
const resolveResponse = ()=>helpers_awaiter(void 0, void 0, void 0, function*() {
        if (typeof Response === "undefined") {
            // @ts-ignore
            return (yield Promise.resolve(/* import() */).then(__webpack_require__.bind(__webpack_require__, 22))).Response;
        }
        return Response;
    });
...
;// CONCATENATED MODULE: ../../node_modules/.pnpm/@supabase+supabase-js@2.49.4/node_modules/@supabase/supabase-js/dist/module/lib/version.js
const lib_version_version = "2.49.4"; //# sourceMappingURL=version.js.map

;// CONCATENATED MODULE: ../../node_modules/.pnpm/@supabase+supabase-js@2.49.4/node_modules/@supabase/supabase-js/dist/module/lib/constants.js
...
;// CONCATENATED MODULE: ../../node_modules/.pnpm/@supabase+supabase-js@2.49.4/node_modules/@supabase/supabase-js/dist/module/lib/fetch.js
...
;// CONCATENATED MODULE: ../../node_modules/.pnpm/@supabase+supabase-js@2.49.4/node_modules/@supabase/supabase-js/dist/module/lib/helpers.js
...
;// CONCATENATED MODULE: ../../node_modules/.pnpm/@supabase+auth-js@2.69.1/node_modules/@supabase/auth-js/dist/module/lib/version.js
const module_lib_version_version = "2.69.1"; //# sourceMappingURL=version.js.map

;// CONCATENATED MODULE: ../../node_modules/.pnpm/@supabase+auth-js@2.69.1/node_modules/@supabase/auth-js/dist/module/lib/constants.js
...
;// CONCATENATED MODULE: ../../node_modules/.pnpm/@supabase+auth-js@2.69.1/node_modules/@supabase/auth-js/dist/module/lib/errors.js
...
;// CONCATENATED MODULE: ../../node_modules/.pnpm/@supabase+auth-js@2.69.1/node_modules/@supabase/auth-js/dist/module/lib/base64url.js
/**
...
;// CONCATENATED MODULE: ../../node_modules/.pnpm/@supabase+auth-js@2.69.1/node_modules/@supabase/auth-js/dist/module/lib/helpers.js
...
;// CONCATENATED MODULE: ../../node_modules/.pnpm/@supabase+auth-js@2.69.1/node_modules/@supabase/auth-js/dist/module/lib/fetch.js
...
;// CONCATENATED MODULE: ../../node_modules/.pnpm/@supabase+auth-js@2.69.1/node_modules/@supabase/auth-js/dist/module/GoTrueAdminApi.js
...
;// CONCATENATED MODULE: ../../node_modules/.pnpm/@supabase+auth-js@2.69.1/node_modules/@supabase/auth-js/dist/module/lib/local-storage.js
...
;// CONCATENATED MODULE: ../../node_modules/.pnpm/@supabase+auth-js@2.69.1/node_modules/@supabase/auth-js/dist/module/lib/polyfills.js
/**
...
;// CONCATENATED MODULE: ../../node_modules/.pnpm/@supabase+auth-js@2.69.1/node_modules/@supabase/auth-js/dist/module/lib/locks.js
...
;// CONCATENATED MODULE: ../../node_modules/.pnpm/@supabase+auth-js@2.69.1/node_modules/@supabase/auth-js/dist/module/GoTrueClient.js
...
;// CONCATENATED MODULE: ../../node_modules/.pnpm/@supabase+auth-js@2.69.1/node_modules/@supabase/auth-js/dist/module/AuthAdminApi.js
...
;// CONCATENATED MODULE: ../../node_modules/.pnpm/@supabase+auth-js@2.69.1/node_modules/@supabase/auth-js/dist/module/AuthClient.js

const AuthClient = GoTrueClient;
/* harmony default export */ const module_AuthClient = (AuthClient); //# sourceMappingURL=AuthClient.js.map

;// CONCATENATED MODULE: ../../node_modules/.pnpm/@supabase+auth-js@2.69.1/node_modules/@supabase/auth-js/dist/module/index.js
...
;// CONCATENATED MODULE: ../../node_modules/.pnpm/@supabase+supabase-js@2.49.4/node_modules/@supabase/supabase-js/dist/module/lib/SupabaseAuthClient.js
...
;// CONCATENATED MODULE: ../../node_modules/.pnpm/@supabase+supabase-js@2.49.4/node_modules/@supabase/supabase-js/dist/module/SupabaseClient.js
...
;// CONCATENATED MODULE: ../../node_modules/.pnpm/@supabase+supabase-js@2.49.4/node_modules/@supabase/supabase-js/dist/module/index.js
...
;// CONCATENATED MODULE: ../../node_modules/.pnpm/@supabase+auth-helpers-shared@0.6.3_@supabase+supabase-js@2.49.4/node_modules/@supabase/auth-helpers-shared/dist/index.mjs
